...
//import com.sp.mallreview.databinding.ActivityMallsLocationBinding;

public class MallsLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malls_location);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment)getSupportFragmentManager()
                .findFragmentById(R.id.mall_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Marker mall = mMap.addMarker(new MarkerOptions().position(MALL).title(mallName));
